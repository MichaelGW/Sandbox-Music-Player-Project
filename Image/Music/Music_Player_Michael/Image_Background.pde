...
int picWidth = 300; //Origonal Dimension, MINE is 800, not yours
int picHeight = 168; //Origonal Dimension, MINE is 600, not yours
...
//
//if ( nightMode==false ) tint(255,128); (Toggle night mode)
//if (nightMode==true) tint(64,64,40); (Toggle night mode)
//No ASPECT RATIO
